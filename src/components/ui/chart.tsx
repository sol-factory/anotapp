...
// --------------------------
// TIPOS “MÍNIMOS” (compatibles con cualquier Recharts)
// --------------------------
        ...
        {payload
          ...
          .map((item, index) => {
            ...
            return (
              ...
              >
                {formatter && itemValue !== undefined ? (
                  formatter(itemValue, itemName, item, index, item.payload)
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
